...
# Define a CNN model using AveragePooling2D instead of MaxPooling2D
def enhanced_cnn_model(input_size=(128, 128, 1), num_classes=2):
    ...
    x = layers.AveragePooling2D((2, 2))(x)  # Changed to AveragePooling2D
