...
# Define a deeper CNN model for classification
def enhanced_cnn_model(input_size=(128, 128, 1), num_classes=2):
    ...
    # Added additional convolutional and pooling layers
    ...
    # Increase the number of dense layers and units
...
def main(image_folder):
    ...
    # Train the model
    history = model.fit(X, y, validation_split=0.2, epochs=15, batch_size=8)  # Increased epochs to 15
