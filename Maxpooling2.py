...
def simple_cnn_model(input_size=(128, 128, 1), num_classes=2):
    ...
    x = layers.Conv2D(32, (3, 3), activation='relu',
                      kernel_regularizer=regularizers.l2(0.001))(inputs)  # L2 Regularization
    x = layers.AveragePooling2D((2, 2))(x)  # Changed to Average Pooling
    ...
    x = layers.Flatten()(x)
    x = layers.Dense(64, activation='relu', kernel_regularizer=regularizers.l2(0.001))(x)  # Reduced neurons
